...
int ossl_param_find_pidx(const char *s)
{
    ...
    case 'a':
        ...
        case 'c':
            ...
            break;
        case 'd':
            if (strcmp("ditional-random", s + 2) == 0)
                            ...
                            case '-':
                                ...
                                case 'p':
                                    if (strcmp("rops", s + 8) == 0)
                                        return PIDX_EXCHANGE_PARAM_DIGEST_PROPS;
                                    break;
                                case 's':
                                    if (strcmp("ize", s + 8) == 0)
    ...
    case 'm':
        ...
        case 'a':
            ...
            break;
        case 'e':
            if (strcmp("ssage-encoding", s + 2) == 0)
    ...
    case 'o':
        ...
        case 'r':
            ...
            break;
        case 'u':
            if (strcmp("tlen", s + 2) == 0)
                return PIDX_EXCHANGE_PARAM_OUTLEN;
        }
        break;
    case 'p':
        switch(s[1]) {
                ...
                case 'r':
                    ...
                    case '-':
                        ...
                        default:
                            break;
                        case 'e':
                            if (strcmp("nc-key", s + 6) == 0)
                                return PIDX_EXCHANGE_PARAM_PEER_ENC_KEY;
                            break;
                        case 'i':
                            if (strcmp("d", s + 6) == 0)
                                return PIDX_EXCHANGE_PARAM_PEER_ID;
                        }
                    }
                }
            }
            ...
            case 'l':
                ...
                case 'f':
                    ...
                    case '-':
                        ...
                        case 'e':
                            if (strcmp("nc-key", s + 6) == 0)
                                return PIDX_EXCHANGE_PARAM_SELF_ENC_KEY;
                            break;
                        case 'i':
                            if (strcmp("d", s + 6) == 0)
                                return PIDX_EXCHANGE_PARAM_SELF_ID;
                        }
                    }
                }
                break;
            ...
            case '2':
                ...
                case '-':
                    ...
                    default:
                        break;
                    case 'i':
                        if (strcmp("nitiator", s + 5) == 0)
                            return PIDX_EXCHANGE_PARAM_INITIATOR;
                        break;
                    case 'z':
                        if (strcmp("a", s + 5) == 0)
                            return PIDX_PKEY_PARAM_SM2_ZA;
                    }
                }
            }
            break;
